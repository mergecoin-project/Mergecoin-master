...
LIBS += $$PWD/src/secp256k1/src/libsecp256k1_la-secp256k1.o
   ...
   isEmpty(SECP256K1_LIB_PATH) {
       windows:SECP256K1_LIB_PATH=D:\Mergecoin-master\src\secp256k1\.libs
   }
   isEmpty(SECP256K1_INCLUDE_PATH) {
       windows:SECP256K1_INCLUDE_PATH=D:\Mergecoin-master\src\secp256k1\include
   }
}
