...
// Copyright (c) 2017 Empinel / The Mergecoin Developers
...
//
// Bootup the masternode, look for a 50000 MGC input and register on the network
//
void CActiveMasternode::ManageStatus()
{
    ...
    if(status == MASTERNODE_NOT_PROCESSED) {
        ...
        if(GetMasterNodeVin(vin, pubKeyCollateralAddress, keyCollateralAddress)) {
            ...
            /* donations are not supported in Mergecoin.conf */
