...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Mergecoin.lnk";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("Mergecoin-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  Mergecoin-Qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    setWindowTitle(tr("Mergecoin-Qt"));
