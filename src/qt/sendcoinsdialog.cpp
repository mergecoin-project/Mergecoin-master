    ...
    fNewRecipientAllowed(true)
{
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a Mergecoin address (e.g. MURTDp3LdR98Cufh9BbSSqUPJFEtPKSLSe)"));
#endif
...
void SendCoinsDialog::coinControlChangeEdited(const QString& text)
{
    if (model && model->getAddressTableModel())
    {
        ...
        {
            ui->labelCoinControlChangeLabel->setText(tr("Warning: Invalid Mergecoin address"));
        }
        else // Valid address
        {
            CPubKey pubkey;
